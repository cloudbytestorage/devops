    ...
    try:
        ...
        if output[0] == "transferring":
            ...
            try:
                ...
                output = t1.cbdpctl_status(user, pwd, host1, vsm_ip)
                if output:
                    print "pass: DR transfer is continued after Nw is up"
                    log.info("pass: DR transfer is continued after Nw is up ")
            except Exception as z:
                print "fail: DR transfer did not continue after Data N/W is up", str(z)
                log.error("fail: DR transfer did not continue after Data N/W is up")
