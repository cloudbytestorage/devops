...
class CharacterValidation():
    ...
    def pool_name(self,no_of_disks):
    ...
    def vsm_name(self, poolnumber, capacity, ip):
        ...
        try:
            ...
            selectpool = self.driver.find_element_by_xpath(
                ".//*[@id='dataTable']/tbody/tr[%s]/td[1]/span['%s']" % (poolnumber, poolnumber))
