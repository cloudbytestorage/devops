...
# TC1 : NFS SMALL FILE OPS 
python AMSx-WLAx-NSWx-NFSx-xxxx-TC_SMALL_FILE_OPS.py conf.txt

# CLEAN 
python cleanup.py conf.txt

# TC2 : NFS LARGE FILE OPS
...
# TC6 : NFS QUOTA CHANGE OPS
python AMSx-WLAx-NSWx-NFSx-VOLx-TC_QUOTA_CHANGE_OPS.py conf.txt

# CLEAN
python cleanup.py conf.txt

# TC7 : NFS QoS GRACE CHANGE OPS
python AMSx-WLAx-NSWx-NFSx-VOLx-TC_QoSx_GRACE_CHANGE_OPS.py conf.txt

# CLEAN
python cleanup.py conf.txt

# TC8 : NFS CONTINUOUS SIGHUP OPS
python AMSx-WLAx-NSWx-NFSx-IORx-TC_CONTINUOUS_SIGHUP_OPS.py conf.txt

# CLEAN
python cleanup.py conf.txt

# TC9 : NFS PROVISION-DEPROVISION OPS
...
# TC13 : ISCSI PROVISION DEPROVISION OPS
python AMSx-WLAx-NSWx-ISCSI-VOLx-TC_PROVISION_DEPROVISION_OPS.py conf.txt
