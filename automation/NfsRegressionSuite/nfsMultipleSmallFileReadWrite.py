...
from vdbenchUtils import is_vdbench_alive, kill_vdbench, executeVdbenchFile

logging.basicConfig(format='%(asctime)s %(levelname)s: %(message)s',\
    filename='logs/automation_execution.log',filemode='a',level=logging.DEBUG)

testcase = 'Multiple Small Read & Write across NFS Volumes(20GB)'
...
#------------------------METHODS-----------------------------------------------------
# to create volume , add nfs client and mount the volume....
...
# copying files from one share to another
logging.info('Copying files from one share to another')
startTime = ctime
...
if copy_large[0] == 'FAILED':
    ...
    logging.debug('copying of  data from one volume to other was successful')
...
# verifying whether copying of files was successful or not
startTime = ctime()
if Used1 == Used2:
