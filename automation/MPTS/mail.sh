...
then
    ...
    mail -s "Automation Report -- `sed -n 1p installed_version` -- $status" -a results/result.csv -r cbauto@cloudbyte.com -c senthilkumar.e@cloudbyte.com, cb-qa@cloudbyte.com, cb-kernel@cloudbyte.com, cb-devman@cloudbyte.com < mail.txt
