...
python createDisableSCSI.py regression.txt NODEIP1 NODEPASSWORD1 logs/disablescsi.txt
should_exit $?
...
should_exit $?
python parseData.py raidz2.txt NODEIP1 NODEPASSWORD1 PoolRaidz2 logs/output/PoolRaidz2
should_exit $?
...
should_exit $?
python parseData.py mirror.txt NODEIP1 NODEPASSWORD1 PoolMirror logs/output/PoolMirror
should_exit $?
...
#python verifyDedup.py regression.txt NODEIP1 NODEPASSWORD1 PoolRaidz1 
#should_exit $?
#python verifyMetaSize.py regression.txt NODEIP1 NODEPASSWORD1 PoolRaidz1 
#should_exit $?
...
python vlanAdd.py regression.txt NODEIP1 NODEPASSWORD1
should_exit $?
python vlanDelete.py regression.txt NODEIP1 NODEPASSWORD1
should_exit $?
python vlanAdd.py regression.txt NODEIP1 NODEPASSWORD1
should_exit $?
python vlanDelete.py regression.txt NODEIP1 NODEPASSWORD1
...
python staticIPAdd.py regression.txt NODEIP1 NODEPASSWORD1 
should_exit $?
python staticIPDelete.py regression.txt NODEIP1 NODEPASSWORD1
should_exit $?
python staticIPAdd.py regression.txt NODEIP1 NODEPASSWORD1
should_exit $?
python staticIPDelete.py regression.txt NODEIP1 NODEPASSWORD1
...
should_exit $?
## reclaim space
python spaceReclaim.py spaceReclaim.txt NODEIP1 NODEPASSWORD1 all
should_exit $?
'''
...
should_exit $?
python discoverHardware.py snapshot.txt disks NODEIP1 NODEPASSWORD1
should_exit $?
...
#sleep 30
#python PoolDedupExecution.py dedup.txt all  NODEIP1 NODEPASSWORD1 on
#delete
...
#python PoolDedupExecution.py dedup.txt all  NODEIP1 NODEPASSWORD1 off
#python PoolDedup.py dedup.txt on
#delete
#python delete.py dedup.txt iscsi
#sleep 5
...
python CompressionExecution.py dedup.txt all on NODEIP1 NODEPASSWORD1
#delete
python delete.py dedup.txt iscsi
sleep 5
...
python CompressionExecution.py dedup.txt all off NODEIP1 NODEPASSWORD1
python Compression.py dedup.txt all on
#Iscsi initiator-group/auth-group/auth-method positive and negative tests
sh IscsiSecurity.sh

sh Readonly.sh
python QosChange.py delete.txt all NODEIP1 NODEPASSWORD1 10 0
python QosLessthanPool.py  delete.txt all NODEIP1 NODEPASSWORD1
python QosDatasetDelete.py delete.txt all NODEIP1 NODEPASSWORD1



### Node maintenance/Available test cases 
sleep 300
python nodeToModeSingleNode.py snapshot.txt maintenance NODEIP1 NODEPASSWORD1
should_exit $?
sleep 5
python nodeToModeSingleNode.py snapshot.txt available NODEIP1 NODEPASSWORD1
should_exit $?
#Ack all alerts
