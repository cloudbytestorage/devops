...
testcase = 'Set initiator group to ALL and discover The LUN'
...
#------------------------------------------------------------------------
#------------Volume details-------------------
vol = {'name': 'iscsiInitAll', 'tsmid': tsmID, 'datasetid': datasetID, \
...
#-------------iscsi details----------------------------
#set initator grp to all....
setInitGroup = assign_iniator_gp_to_LUN(stdurl, volid, account_id, 'ALL')
