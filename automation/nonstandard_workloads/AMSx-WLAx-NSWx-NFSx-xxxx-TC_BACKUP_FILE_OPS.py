...
'''
###############################################################################################################
# Testcase Name : Continuous_Backup_Ops_NFS                                                                   #
#                                                                                                             #
# Testcase Description : This test performs the following actions :                                           #
#                        a) Creates multiple large files of specified size on the NFS volume,                 #
#                        b) Sets up rsync with a destination/backup folder/Performs initial copy              #
#                        b) writes into the above file                                                        #
#                        c) reads from the above file and                                                     # 
#                        d) Rsyncs again                                                                      #
#                        e) Repeats the workload and rsync for fixed set of iterations                        #
#                                                                                                             #
#                                                                                                             # 
...
EXECUTE_SYNATX = 'python %s.py conf.txt'
